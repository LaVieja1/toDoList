...
class UI {
    ...
    static addProject() {
        ...
        addProjectPopupInput.value = ''
        alert('El nombre del proyecto ya esta en uso')
        return
        }
    ...
    static addTask() {
        ...
        alert('El nombre de la tarea ya esta en uso')
        ...
        UI.createTask(taskName, 'No hay fecha')
        UI.closeAddTaskPopup()
    }
